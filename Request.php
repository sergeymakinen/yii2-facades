 ...
 * @method static bool getEnableCookieValidation() Returns $enableCookieValidation - whether cookies should be validated to ensure they are not tampered.
 * @method static bool getEnableCsrfCookie() Returns $enableCsrfCookie - whether to use cookie to persist CSRF token.
 * @method static bool getEnableCsrfValidation() Returns $enableCsrfValidation - whether to enable CSRF (Cross-Site Request Forgery) validation.
 ...
 * @method static setEnableCookieValidation(bool $value) Sets $enableCookieValidation - whether cookies should be validated to ensure they are not tampered.
 * @method static setEnableCsrfCookie(bool $value) Sets $enableCsrfCookie - whether to use cookie to persist CSRF token.
 * @method static setEnableCsrfValidation(bool $value) Sets $enableCsrfValidation - whether to enable CSRF (Cross-Site Request Forgery) validation.
