 ...
 * @method static int getAbsoluteAuthTimeout() Returns $absoluteAuthTimeout - the number of seconds in which the user will be logged out automatically regardless of activity.
 ...
 * @method static int getAuthTimeout() Returns $authTimeout - the number of seconds in which the user will be logged out automatically if he remains inactive.
 ...
 * @method static bool getAutoRenewCookie() Returns $autoRenewCookie - whether to automatically renew the identity cookie each time a page is requested.
 * @method static bool getEnableAutoLogin() Returns $enableAutoLogin - whether to enable cookie-based login.
 * @method static bool getEnableSession() Returns $enableSession - whether to use session to persist authentication status across multiple requests.
 ...
 * @method static setAbsoluteAuthTimeout(int $value) Sets $absoluteAuthTimeout - the number of seconds in which the user will be logged out automatically regardless of activity.
 ...
 * @method static setAutoRenewCookie(bool $value) Sets $autoRenewCookie - whether to automatically renew the identity cookie each time a page is requested.
 * @method static setEnableAutoLogin(bool $value) Sets $enableAutoLogin - whether to enable cookie-based login.
 * @method static setEnableSession(bool $value) Sets $enableSession - whether to use session to persist authentication status across multiple requests.
